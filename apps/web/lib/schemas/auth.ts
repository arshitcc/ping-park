...
export const loginSchema = z.object({
  user: z.string().min(3, "Enter a valid username or email"),
...
export const updateProfileSchema = z.object({
  ...
  phone: z
    .string()
    .regex(phoneRegex, {
      message: "Enter valid Indian 10-digit phone number",
    })
    .optional(),
});
...
export const forgotPasswordRequestSchema = z.object({
  user: z
    .string()
    .min(10, "Email or Phone number must be at least 5 characters")
    .max(60, "Email or Phone number must be maximum 60 characters"),
});
